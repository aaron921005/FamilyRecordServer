...
INSERT INTO `sy_user` VALUES (1,'Aaron南无阿弥陀佛','e10adc3949ba59abbe56e057f20f883e','user','Aaron南无阿弥陀佛','https://wx.qlogo.cn/mmopen/vi_32/ZJ5zJc0Ge9KkTutCicxYuvTbLJKPp1LWcRiaDbKAG3TtSddmOpia8ZMjQS6N00uVJvBKdE1nFLWeFaJt5kCWP59SQ/0','2017-12-06 12:24:50','欢迎您,Aaron南无阿弥陀佛','o_ZwU0R-b8bAaR8nhCJ7qWXMiA7A','男',NULL),(3,'南无阿弥陀佛','e10adc3949ba59abbe56e057f20f883e','user','南无阿弥陀佛','https://bjlsjp.cn/img/system/laopo.jpg','2017-12-07 09:41:24','欢迎您,南无阿弥陀佛','o_ZwU0S0v_zrWxUGXN3en1sV6eIc','女',NULL);
...
CREATE TABLE `sy_user_babynurse` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=147 DEFAULT CHARSET=utf8 COMMENT='宝宝吃奶';
...
CREATE TABLE `sy_userlife` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='用户生活';
