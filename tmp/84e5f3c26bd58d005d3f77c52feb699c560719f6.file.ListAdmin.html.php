<?php /* Smarty version Smarty-3.0.8, created on 2017-12-06 08:12:31
         compiled from "D:\phpStudy\FamilyRecordServer/tpl\admin/user_babynurse/ListAdmin.html" */ ?>
<?php /*%%SmartyHeaderCode:161965a27a66f216e11-68133333%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '84e5f3c26bd58d005d3f77c52feb699c560719f6' => 
    array (
      0 => 'D:\\phpStudy\\FamilyRecordServer/tpl\\admin/user_babynurse/ListAdmin.html',
      1 => 1512372510,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '161965a27a66f216e11-68133333',
  'function' => 
  array (
  ),
...
<span class="fl">
<a class="btn btn-success" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'user','a'=>'add'),$_smarty_tpl);?>
...
<table  class="table table-hover table-bordered">
  <tr class="active">
    ...
    <td align="center" class="bgc"><strong>微信名称</strong></td>
    <td align="center" class="bgc"><strong>用户类别</strong></td>
...
?>
  <tr>
    ...
    <td align="center"><?php echo $_smarty_tpl->tpl_vars['one']->value['wxname'];?>
</td>
    <td align="center"><?php if ($_smarty_tpl->tpl_vars['one']->value['admin']=='admin'){?>系统用户<?php }elseif($_smarty_tpl->tpl_vars['one']->value['admin']=='user'){?>普通用户<?php }?></td>
    <td align="center">
      <a class="btn btn-primary btn-xs" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'user','a'=>'update','id'=>$_smarty_tpl->tpl_vars['one']->value['id']),$_smarty_tpl);?>
...
function delconfirm(id,username){
	if( window.confirm("确定删除“" + username + "”？") ){
		window.location = "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'user','a'=>'del'),$_smarty_tpl);?>
&id=" + id;
	}
}
</script>
