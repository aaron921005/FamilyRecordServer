<?php /* Smarty version Smarty-3.0.8, created on 2017-12-04 03:28:29
         compiled from "D:\phpStudy\FamilyRecordServer/tpl\guestbook/default/index.html" */ ?>
<?php /*%%SmartyHeaderCode:227975a24c0ddacfa67-04048930%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c05935f9e5b7ca84de2b8384287baa0e50ab3c9f' => 
    array (
      0 => 'D:\\phpStudy\\FamilyRecordServer/tpl\\guestbook/default/index.html',
      1 => 1511400699,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '227975a24c0ddacfa67-04048930',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_function_cycle')) include 'D:\phpStudy\FamilyRecordServer\SpeedPHP\Drivers\Smarty\plugins\function.cycle.php';
...
" width="930"/></div>
  ...
  <div class="nav">
    ...
    <div class="fr">欢迎来自<?php echo replaceIp(array('ip'=>$_smarty_tpl->getVariable('ip')->value),$_smarty_tpl);?>
...
）的网友！</div>
  ...
  <div class="gIntroduction"><?php echo $_smarty_tpl->getVariable('g')->value['gIntroduction'];?>
</div>
...
&amp;tm='+Math.random()"></td>
  ...
  <div class="sm fr">
    ...
    <div class="b15"></div>
    <img src="<?php echo (($tmp = @$_smarty_tpl->getVariable('g')->value['gLogo'])===null||$tmp==='' ? 'tpl/guestbook/default/images/logo.jpg' : $tmp);?>
" width="250" height="60" />
  </div>
  <div class="clear"></div>
</div>
...
<div class="footer">
 ...
 <?php echo $_smarty_tpl->getVariable('g')->value['gTongji'];?>
  ...
  <span class="fr">Powered by <a href="http://www.sucainiu.com" target="_blank">www.sucainiu.com</a></span>
  <div class="clear"></div>
</div>
